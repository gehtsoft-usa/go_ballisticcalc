...
func TestAngular(t *testing.T) {
	angularBackAndForth(t, 5, unit.AngularDegree)
...
func TestDistance(t *testing.T) {
	...
	distanceBackAndForth(t, 5, unit.DistanceCentimeter)
	distanceBackAndForth(t, 5, unit.DistanceFoot)
	distanceBackAndForth(t, 5, unit.DistanceInch)
	distanceBackAndForth(t, 5, unit.DistanceKilometer)
	distanceBackAndForth(t, 5, unit.DistanceLine)
	distanceBackAndForth(t, 5, unit.DistanceMeter)
	distanceBackAndForth(t, 5, unit.DistanceMile)
	distanceBackAndForth(t, 5, unit.DistanceMillimeter)
	distanceBackAndForth(t, 5, unit.DistanceNauticalMile)
	distanceBackAndForth(t, 5, unit.DistanceYard)
}

func TestEnergy(t *testing.T) {
	energyBackAndForth(t, 5, unit.EnergyFootPound)
	energyBackAndForth(t, 3, unit.EnergyFootPound)
	energyBackAndForth(t, 3, unit.EnergyJoule)
}

func TestPressure(t *testing.T) {
	pressureBackAndForth(t, 7, unit.PressureBar)
...
func TestTemperature(t *testing.T) {
	temperatureBackAndForth(t, 9, unit.TemperatureCelsius)
...
func TestVelocity(t *testing.T) {
	velocityBackAndForth(t, 5, unit.VelocityFPS)
...
func TestWeight(t *testing.T) {
	weightBackAndForth(t, 7, unit.WeightGrain)
